namespace Study_Csharp_deep
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.button7.Text = "참조변수(인스턴스+함수이용)";
